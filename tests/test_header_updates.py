...
from su2_mcp.cpacs_adapter import write_to_cpacs

PACKAGE = "su2-mcp"
RESULTS = {"solver": "su2_cfd", "converged": True, "CL": 0.2, "CD": 0.01}
RESULTS_NODE = ".//vehicles/aircraft/model/analysisResults/aero"
